...
import CrimeCarousel from './pages/index'
...
export default function App() {
  ...
  <View style={{flex: 1, backgroundColor: '#d6d6d6'}}>
    <View style={styles.header}>
      <Text style={styles.headerText}>Dados e Históricos</Text>
    </View>
    <ScrollView>
      <CrimeCarousel/>
      <Text style={styles.title}>Índice de Violência</Text>
      <StackedBarChart
        style={{
          marginTop: 30,
          marginBottom: 30,
      ...
      />
      <Text style={styles.title}>Denuncias por bairro (%)</Text>
      <PieChart
        style={{
          marginTop: 30,
          marginBottom: 30,
